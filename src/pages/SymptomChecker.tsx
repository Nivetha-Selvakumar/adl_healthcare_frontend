                ...
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                    ...
                    <div className="mt-6 flex space-x-4">
                        <button 
                            ...
                            className={`flex-1 py-3.5 rounded-xl font-bold shadow-sm transition-all ${
                                selectedSymptoms.length === 0 || symptomCheckLoading
                            ...
                            <div className={`p-5 rounded-2xl mb-6 ${
                                ...
                                <div className="flex items-center space-x-3 mb-2">
                                    ...
                                    <h3 className={`text-lg font-bold ${
                                        symptomCheckResult.possibleIllness.includes("URGENT") ? "text-red-800" : "text-green-800"
                                    }`}>
                                        {symptomCheckResult.possibleIllness}
                                    </h3>
                                </div>
                            </div>
